...
var _reactImageViewer = require('react-image-viewer');
...
var Gallery = (function (_Component) {
	...
	function Gallery() {
		...
		this.state = {
			BlackboxIsOpen: false,
			currentImage: 0
		};

		this.closeBlackbox = this.closeBlackbox.bind(this);
		this.gotoNext = this.gotoNext.bind(this);
		this.gotoPrevious = this.gotoPrevious.bind(this);
		this.gotoImage = this.gotoImage.bind(this);
		this.handleClickImage = this.handleClickImage.bind(this);
		this.openBlackbox = this.openBlackbox.bind(this);
	}

	_createClass(Gallery, [{
		key: 'openBlackbox',
		value: function openBlackbox(index, event) {
...
},{"aphrodite/no-important":8,"prop-types":undefined,"react":undefined,"react-image-viewer":undefined}],3:[function(require,module,exports){
'use strict';
